...
const Cart = () => {
  ...
  const searchQuery = params.get("productName");
  return (
    <div>
            ...
            <div className="mt-8">
              <ul className="space-y-4">
                <li className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-sm text-gray-900">{searchQuery}</h3>
                  </div>
                ...
                <div className="w-screen max-w-lg space-y-4">
                  ...
                  <div className="flex justify-end">
                    <button
                      ...
                      className="block rounded bg-primary hover:bg-emerald-600 px-5 py-3 text-sm text-white transition"
                    >
                      Checkout
                    </button>
                  </div>
