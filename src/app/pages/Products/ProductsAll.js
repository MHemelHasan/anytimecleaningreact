  ...
  return (
    <div className="px-8 md:px-20 mx-auto my-20">
      {loading ? (
        ...
        // <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-y-10 gap-x-6 lg:col-span-3 lg:gap-x-8 w-full">
        /*  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-x-32 w-full">
        ...
        <div class=" grid grid-cols-2 gap-x-6 gap-y-10 px-2 pb-20 sm:grid-cols-3 sm:px-8 lg:mt-16 lg:grid-cols-3 lg:gap-x-4 lg:px-0">
          {products?.map((product) => (
            <Product key={product?.id} {...product} />
            // <div className="card w-80 glass" key={product?.id}>
            //   <figure>
            //     <img
            ...
            //     <h2 className="card-title">{product?.name?.en}</h2>
            ...
            //   </div>
            // </div>
            // <article class="relative card" key={product?.id}>
            //   <div class="aspect-square overflow-hidden">
            //     <img
            //       class="rounded-3xl h-full w-full object-cover transition-all duration-300 group-hover:scale-125"
